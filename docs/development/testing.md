...
Full-stack browser journeys use Playwright against a scenario-seeded `dem-dev` environment.
See [End-to-end testing with dem-dev](dem-dev-e2e.md) for the local and pull-request workflow.
