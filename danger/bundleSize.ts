...
export function bundleSizeDiff() {
  const mainBundleSize = getFile('mainBundleSize.json')
  const currentBundleSize = getFile('currentBundleSize.json')
...
function getFile(file) {
  return require(path.resolve(process.cwd(), file))e('fs')
