...
INSTALL_COMMAND='grafana-cli --pluginUrl='"https://github.com/grafana/synthetic-monitoring-app/releases/download/v$TAG/grafana-synthetic-monitoring-app-$TAG.zip"' plugins install grafana-synthetic-monitoring-app'
