...
const OPPORTUNITY = {
  id: 'http-suggestion',
  subject: 'mcp.goagain.dev',
  proposedCheck: { checkType: 'http' },
} as ReliabilityOpportunity;
...
describe('ReliabilityInboxBanner', () => {
  ...
  it('links the next recommendation to the review page', async () => {
    ...
    expect(trackReviewEntryClicked).toHaveBeenCalledWith({ opportunityId: 'http-suggestion', checkType: 'http' });
  });
