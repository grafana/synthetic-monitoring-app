...
export const reliabilitySuggestionSchema = z.object({
  ...
  checkType: z.string(),
  // The namespace whose telemetry produced this suggestion, and the other
  // ownership hints from the same series. Optional: a host the stack serves
  // may carry no ownership labels at all, and that is unattributed rather
  // than an error.
  namespace: z.string().optional(),
  ownerLabels: z.record(z.string(), z.string()).optional(),
  evidence: z.object({
