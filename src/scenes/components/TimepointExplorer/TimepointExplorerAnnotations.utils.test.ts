...
describe('getCheckEventsInRange', () => {
  it('should return the check events that are in the range', () => {
    const checkEvents = [{ from: 30000, to: 30000, label: CheckEventType.CheckCreated, color: 'blue' }];
  ...
  it('should not return the check events that do not intersect the range', () => {
    const checkEvents = [
      { from: 10000, to: 15000, label: CheckEventType.CheckCreated, color: 'blue' }, // completely before
      { from: 120000, to: 130000, label: CheckEventType.CheckUpdated, color: 'blue' }, // completely after
    ];
    const timepointsInRange = buildTimepoints({
      checkConfigs: [{ frequency: 10000, from: 0, to: 100000 }],
      limitFrom: 30000,
  ...
  it('should return partially overlapping range annotations', () => {
    const checkEvents = [
      { from: 20000, to: 35000, label: CheckEventType.CheckCreated, color: 'blue' }, // starts before, ends in range
      { from: 90000, to: 120000, label: CheckEventType.CheckUpdated, color: 'blue' }, // starts in range, ends after
      { from: 10000, to: 120000, label: CheckEventType.CheckUpdated, color: 'blue' }, // spans entire range
    ];
    const timepointsInRange = buildTimepoints({
      checkConfigs: [{ frequency: 10000, from: 0, to: 100000 }],
      limitFrom: 30000,
...
describe('getClosestTimepointsToCheckEvent', () => {
  it('should return the closest timepoints to the check event', () => {
    const checkEvents = [{ from: 30000, to: 40001, label: CheckEventType.CheckCreated, color: 'blue' }];
    const timepointsInRange = buildTimepoints({
      checkConfigs: [{ frequency: 10000, from: 0, to: 100000 }],
      limitFrom: 30000,
      limitTo: 100000,
  ...
  it('should handle range annotations that start before visible range', () => {
    const checkEvents = [{ from: 10000, to: 40001, label: CheckEventType.CheckUpdated, color: 'blue' }];
    const timepointsInRange = buildTimepoints({
      checkConfigs: [{ frequency: 10000, from: 0, to: 100000 }],
      limitFrom: 30000,
      limitTo: 100000,
  ...
  it('should handle range annotations that end after visible range', () => {
    const checkEvents = [{ from: 30000, to: 150000, label: CheckEventType.CheckUpdated, color: 'blue' }];
    const timepointsInRange = buildTimepoints({
      checkConfigs: [{ frequency: 10000, from: 0, to: 100000 }],
      limitFrom: 30000,
      limitTo: 100000,
  ...
  it('should handle range annotations that span completely across visible range', () => {
    const checkEvents = [{ from: 10000, to: 150000, label: CheckEventType.CheckUpdated, color: 'blue' }];
    const timepointsInRange = buildTimepoints({
      checkConfigs: [{ frequency: 10000, from: 0, to: 100000 }],
      limitFrom: 30000,
      limitTo: 100000,
  ...
  it(`should favour the later timepoint when the event happens at the start of one and beginning of another`, () => {
    const checkEvents = [{ from: 10000, to: 10000, label: CheckEventType.CheckCreated, color: 'blue' }];
    const timepointsInRange = buildTimepoints({
