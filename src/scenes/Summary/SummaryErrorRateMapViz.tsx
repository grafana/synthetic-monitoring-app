...
export const SummaryErrorRateMapViz = () => {
  ...
  const title = getCheckTypeTitle(checkTypeVar, ' error rate by location');

  return <VizPanel menu={menu} title={title} viz={viz} dataProvider={dataTransformer} />;
};
