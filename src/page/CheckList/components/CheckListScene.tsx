...
function getCheckListScene(config: VizViewSceneAppConfig & CheckListSceneProps, checkCount: number) {
...
export function CheckListScene({ onChangeViewType, checkFilters, onReset, onFilterChange }: CheckListSceneProps) {
