  ...
  describe(`Single request`, () => {
    ...
    describe(`Set variables`, () => {
      it(`can set a JSON path variable`, async () => {
        ...
        await selectOption(user, { dataTestId: 'variable-type-combobox', option: 'JSON Path' });
      ...
      it(`can set a Regular Expression variable`, async () => {
        ...
        await selectOption(user, { dataTestId: 'variable-type-combobox', option: 'Regular Expression' });
      ...
      it(`can set a CSS selector variable`, async () => {
        ...
        await selectOption(user, { dataTestId: 'variable-type-combobox', option: 'CSS Selector' });
