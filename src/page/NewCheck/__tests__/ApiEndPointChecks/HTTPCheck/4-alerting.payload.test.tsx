...
describe(`HttpCheck - Section 4 (Alerting) payload`, () => {
  ...
  it(`can add specific http alerts`, async () => {
    ...
    await user.clear(screen.getByTestId('alert-threshold-HTTPTargetCertificateCloseToExpiring'));

    await user.type(screen.getByTestId('alert-threshold-HTTPTargetCertificateCloseToExpiring'), '1');
