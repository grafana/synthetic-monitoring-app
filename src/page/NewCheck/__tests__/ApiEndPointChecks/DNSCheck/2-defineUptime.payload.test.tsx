...
import { selectComboboxOption } from 'components/Checkster/__testHelpers__/formHelpers';
...
describe(`DNSCheck - Section 2 (Define uptime) payload`, () => {
  ...
  describe(`can add valid response matches`, () => {
    it(`can fail if authority matches`, async () => {
      ...
      await selectOption(user, { dataTestId: 'dns-response-match-select-1', option: 'Fail if Authority matches' });
    ...
    it(`can fail if answer matches`, async () => {
      ...
      await user.click(screen.getByText('Add Regex Validation'));
      await selectOption(user, { dataTestId: 'dns-response-match-select-1', option: 'Fail if Answer matches' });
    ...
    it(`can fail if additional matches`, async () => {
      ...
      await user.click(screen.getByText('Add Regex Validation'));
      await selectOption(user, { dataTestId: 'dns-response-match-select-1', option: 'Fail if Additional matches' });    
