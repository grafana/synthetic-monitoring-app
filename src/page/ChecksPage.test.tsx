...
function RouteWrapper({ children, meta, initialEntries }: ComponentWrapperProps) {
  return (
...
describe('Checks page', () => {
  ...
  test('renders editor button on cards', async () => {
    await renderChecksPage();
    const editButtons = await screen.findAllByTestId(CHECKS_TEST_ID.listItem.editButton);
