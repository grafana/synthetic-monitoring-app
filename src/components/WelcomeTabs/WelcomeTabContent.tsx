  ...
  switch (activeTab) {
      ...
      return (
        <>
          <div className={styles.text}>
            <Trans i18nKey="welcome.tabs.protocol-content">
              Send individual requests via HTTP, DNS, TCP, PING or traceroute
            </Trans>
          </div>
    ...
    case WelcomeTab.K6:
      return (
        <>
          <div className={styles.text}>
            <Trans i18nKey="welcome.tabs.scripting-content">Use k6 scripts to monitor your services flexibly</Trans>
          </div>
          <CodeSnippet
            canCopy={true}
    ...
    case WelcomeTab.PrivateProbes:
      return (
        <>
          <div className={styles.text}>
            <Trans i18nKey="welcome.tabs.probes-content">
    ...
    case WelcomeTab.AsCode:
      return (
        <>
          <div className={styles.text}>
            <Trans i18nKey="welcome.tabs.as-code-content">
